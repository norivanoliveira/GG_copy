...
local AngleBetween = function(vec1, vec2)
...
local WriteToFile = function(path, str)
...
local GetControlPos = function(a, b, c)
    local pos
...
--]]
local GetBuffTypes = function(menu)
    return {
        [5] = menu.Stun:Value(),
        [12] = menu.Snare:Value(),
...
Menu = {
    ...
    CreateGeneral = function(self)
        ...
        self.Main:MenuElement({name = 'Version  ' .. __version__, type = _G.SPACE, id = 'VersionSpaceB'})
    end,
}
Menu:CreateMain()
Menu:CreateTarget()
